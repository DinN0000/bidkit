...
│          │  Each Team Contains:  │                │               │
│          │                       │                │               │
│          │  Team Lead ─── 작업 조율, 질문 관리     │               │
│          │      │                │                │               │
│          │      ├── Writer ──── 본문 작성         │               │
│          │      │                │                │               │
│          │      ├── Researcher ─ 스펙·레퍼런스 수집│               │
│          │      │                │                │               │
│          │      └── Critic ──── 품질·규정 검증    │               │
│          │                       │                │               │
│          └───────────────────────┘                │               │
...
└────────────────────────────────────────────────────────────────────┘
    ...
    │                                              │
    │  ✗ 용어 불일치    같은 서버, 다른 이름?       │
    │  ✗ 수치 불일치    아키텍처 10대 vs 비용표 8대  │
    │  ✗ 요구사항 누락  RFP 항목 빠뜨린 건?         │
    │  ✗ 규정 미준수    보안 가이드라인 충족 여부     │
    │                                              │
    └──────────────────────────────────────────────┘
```
