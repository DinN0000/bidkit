...
check_file "skills/notion/SKILL.md"
echo ""

echo "Playbooks (natural language only):"
check_file "playbooks/diagnose/SKILL.md"
check_file "playbooks/output/SKILL.md"
echo ""
...
check_file "reference/style-guide.md"
check_file "reference/doctypes/proposal.md"
check_file "reference/doctypes/portfolio.md"
check_file "reference/doctypes/business-report.md"
check_file "templates/init/criteria-trace-matrix.md"
...
if [ -f "CLAUDE.md" ] && [ -f "AGENTS.md" ]; then
  ...
  for ref_file in agents/overseer.md agents/team-lead.md agents/writer.md agents/researcher.md agents/critic.md skills/design/SKILL.md skills/write/SKILL.md skills/status/SKILL.md skills/setup/SKILL.md skills/notion/SKILL.md playbooks/diagnose/SKILL.md playbooks/output/SKILL.md; do
